(function () {
  ...
  var topicMatchers = {
    formatter: ["formatter", "format", "lint", "linter", "xmllint", "well formed", "valid", "indent", "cleanup", "schema", "config validation", "csv", "utf8", "encoding", "json", "json path", "null", "undefined", "ndjson", "xml", "xpath", "namespace", "yaml", "anchors", "compose", "sql", "python"],
