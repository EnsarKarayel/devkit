...
- Test `index.html`, `xml-formatter.html`, `regex-tester.html`, `jwt-decoder.html`, `timestamp-converter.html`, `base64-encoder-decoder.html`, `url-encoder-decoder.html`, `hash-generator.html`, `cron-expression-parser.html`, `uuid-generator.html`, `color-converter.html`, `csv-to-json.html`, `privacy.html`, `terms.html`, `robots.txt`, `sitemap.xml`, `ads.txt`, and `.well-known/security.txt`.
